...
import { ChessMove, ComputerConfiguration, StockfishQueryParams, StockfishResponse, stockfishLevels, FENChar } from './models';
...
export class StockfishService {
  ...
  public getBestMove(fen: string): Observable<ChessMove> {
    ...
    let params = new HttpParams({ fromObject: queryParams as unknown as { [key: string]: string | number | boolean | readonly (string | number | boolean)[] } });
